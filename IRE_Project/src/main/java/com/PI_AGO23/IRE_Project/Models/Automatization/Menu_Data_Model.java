...
public class Menu_Data_Model {
    ...
    private Map<String, List<Extra_Data_Model>> Extra_Info = new HashMap<>();

    //Constructor

    public Menu_Data_Model() {}
    public Menu_Data_Model(Map<String, Integer> dish_Kind_Amount_Info, Map<String, List<Extra_Data_Model>> extra_Info) {
    ...
    public Map<String, List<Extra_Data_Model>> getExtra_Info() {
        return Extra_Info;
    }

    public void setExtra_Info(Map<String, List<Extra_Data_Model>> extra_Info) {
        Extra_Info = extra_Info;
    }
}
