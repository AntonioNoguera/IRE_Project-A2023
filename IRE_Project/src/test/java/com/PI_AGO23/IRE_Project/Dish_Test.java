...
public class Dish_Test {
    ...
    //GetByIdMethods
    @Test
    public void testGetDishByIdWhenDishExistsAndIsActive() {
        Long dishId = 1L;
    ...
    @Test
    public void testGetDishByIdWhenDishExistsAndIsNotActive() {
        Long dishId = 1L;
        Dish_Model dishModel = new Dish_Model();
        dishModel.setDish_ID(dishId);
    ...
    @Test
    public void testGetDishByIdWhenDishDoesntExist() {
        Long dishId = 2L;
        Dish_Model dishModel = new Dish_Model();
        dishModel.setDish_ID(dishId);
        dishModel.setDish_is_Active(false);
    ...
    //DeleteDish
    @Test
    public void testDeleteDishWhenIDExists() {
    ...
    @Test
    public void testDeleteDishWhenDishAlreadyDown() {
        Dish_Model dish = new Dish_Model();
    ...
    @Test
    void testNewDish_Success() throws Exception {
    ...
    @Test
    void testNewDish_Failure() throws Exception {
        Dish_Service mock = mock(Dish_Service.class);
    ...
    @Test
    void testNewDish_Conflict() throws Exception {
        Dish_Service mock = mock(Dish_Service.class);
        Post_Dish_Model dish = new Post_Dish_Model("Test", true, "Fro", 1L, 8L, 9L, 6L);
    ...
    @Test
    void updatingDish_Success() throws Exception {
        long ID=1;
        Dish_Service mock = mock(Dish_Service.class);
    ...
    @Test
    void updatingDish_NotFounded() throws Exception {
        long ID=1;
        Dish_Service mock = mock(Dish_Service.class);
    ...
    @Test
    void updatingDish_BadRequest() throws Exception {
        long ID=1;
        Dish_Service mock = mock(Dish_Service.class);

        Dish_Model dish = new Dish_Model(1L,"Testing",true,"Fríos","2023-10-13 10:22:54",1,1,1,1,1,1,"des",true);
        Put_Dish_Model Request = new Put_Dish_Model(dish);
    ...
    @Test
    void testGetDishes() {
        ArrayList<Dish_Model> model = new ArrayList<>();

        model.add(new Dish_Model(1L,"Testing",true,"Fríos","2023-10-13 10:22:54",1,1,1,1,1,1,"des",true));
        // Configura objetos mock para el repositorio y el servicio
        when(dishRepository.getAllActiveDishes()).thenReturn(model);

        // Ejecuta el método que deseas probar
        ArrayList<Get_Dish_Model> result = dishService.get_Dishes();

        // Realiza afirmaciones para verificar el resultado
        assertNotNull(result);
        // Realiza más afirmaciones según tu lógica de negocio
    }
}
