...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-10-2023 a las 21:55:18
...
(6, 'Tacos Nuevo Des', 0, 'Frío', '2023-10-21 08:29:18', 555, 80, 1, 2, 3, 2, 0, 'IRE_Project\\IRE_Project\\src\\main\\resources\\images\\placeholder.png'),
(7, 'Quesadillas de Postman', 1, 'Caliente', '2023-10-21 08:24:29', 0, 0, 8, 9, 7, 2, 0, 'IRE_Project\\src\\main\\esources\\images\\default.png'),
(8, 'Tacos Validados', 1, 'Frío', '2023-10-21 08:53:43', 0, 0, 8, 9, 13, 2, 1, 'IRE_Project\\src\\main\\esources\\images\\default.png'),
(9, 'Tacos Verificando', 1, 'Caliente', '2023-10-22 07:09:14', 0, 0, 8, 9, 7, 5, 1, 'IRE_Project\\src\\main\\esources\\images\\default.png'),
(10, 'Tacos Veriaficando', 1, 'Caliente', '2023-10-22 07:09:27', 0, 0, 8, 9, 7, 5, 1, 'IRE_Project\\src\\main\\esources\\images\\default.png'),
(11, 'Tacos e', 1, 'Caliente', '2023-10-22 07:09:39', 0, 0, 8, 9, 7, 5, 1, 'IRE_Project\\src\\main\\esources\\images\\default.png');
...
(9, 'Pollo', '', 2),
(10, 'Salsa Verde', '', 1),
(11, 'POSTMAN 2', 'TEXTO DE POSTMAN', 2),
(12, 'Testing NEO', 'TEXTO DE POSTMAN', 3),
(13, 'newONe', 'string', 3);
...
CREATE TABLE `requisition_table` (
  `Requisition_ID` int(10) UNSIGNED NOT NULL,
  `Requisition_Day_Name` varchar(8) NOT NULL,
  `Requisition_Date` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `requisition_table`
--

INSERT INTO `requisition_table` (`Requisition_ID`, `Requisition_Day_Name`, `Requisition_Date`) VALUES
(5, 'Sábado', '2023-10-21'),
(8, 'Sábado', '2023-10-28'),
(9, 'Viernes', '2023-10-20');
...
ALTER TABLE `requisition_table`
  ...
  ADD UNIQUE KEY `UniqueDay` (`Requisition_Date`);
...
--
ALTER TABLE `dish_table`
  MODIFY `Dish_ID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `extras_table`
--
ALTER TABLE `extras_table`
  MODIFY `Extras_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `requisition_table`
  MODIFY `Requisition_ID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
